      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-md text-indigo-600 px-5 py-2 rounded-2xl text-sm font-bold mb-6 border border-indigo-100 shadow-xl shadow-indigo-500/5"
          >
          ...
          <motion.h1
            ...
            className="text-5xl md:text-6xl lg:text-7xl font-black text-slate-900 mb-6 leading-[1.1] tracking-tight"
          >
          ...
          <motion.p
            ...
            className="text-lg sm:text-xl text-slate-600 mb-10 max-w-2xl mx-auto leading-relaxed font-medium"
          >
          ...
          >
            {[
              ...
              <div
                key={text}
                className="flex items-center gap-2.5 text-slate-700 font-semibold bg-white/50 backdrop-blur-sm px-5 py-2.5 rounded-2xl border border-white/40 shadow-sm hover:shadow-md hover:bg-white/80 transition-all duration-300"
              >
