      ...
      return (
        <div className="flex flex-col items-center justify-center py-32 space-y-4">
          <div className="relative">
            <div className="w-16 h-16 rounded-full bg-indigo-50/60 backdrop-blur-sm flex items-center justify-center animate-pulse-glow">
        ...
        <div className='product-grid' id='product-grid'>
            <div className="flex justify-between items-center mb-10">
              ...
              <div className="flex items-center gap-2 text-sm font-bold text-slate-500">
                <span className="bg-white/70 backdrop-blur-sm px-4 py-2 rounded-xl border border-white/40 shadow-sm">
            ...
            {filteredList.length === 0 && (
              <div className="text-center py-32 bg-white/60 backdrop-blur-sm rounded-[3rem] border-dashed border-2 border-slate-200/40 animate-scale-in">
                <div className="w-20 h-20 bg-indigo-50/60 backdrop-blur-sm rounded-3xl flex items-center justify-center mx-auto mb-6 animate-float shadow-lg shadow-indigo-100/20">
