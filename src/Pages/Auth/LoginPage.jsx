          ...
          >
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <button type="button" className="h-14 bg-white/50 border border-slate-200 rounded-xl font-bold text-slate-600 flex items-center justify-center gap-3 hover:bg-white transition-all text-sm shadow-sm backdrop-blur-sm">
