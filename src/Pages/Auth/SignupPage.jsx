...
const PasswordStrengthIndicator = ({ strength }) => {
  ...
  return (
    <div className="mt-2">
      ...
      {strength !== 'none' && <p className="text-xs font-bold text-slate-500">{labels[strength]}</p>}
    </div>
  );
};
...
const SignupPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#f8faff] relative overflow-hidden font-['Inter']">
      ...
      <div className="w-full md:w-[45%] p-8 md:p-16 flex flex-col justify-center relative z-10 overflow-y-auto no-scrollbar">
        <div className="max-w-md w-full mx-auto">
          <div className="flex items-center gap-3 mb-8 group cursor-pointer lg:mb-12">
            ...
            <span className="text-2xl font-black text-slate-900 tracking-tight">Campus<span className="text-emerald-700">Trade</span></span>
          </div>

          <motion.div 
            initial={{ opacity: 0, scale: 0.98 }}
            animate={{ opacity: 1, scale: 1 }}
            className="glass-premium p-8 md:p-12 rounded-[3.5rem] shadow-ambient border border-white/40"
          >
            <div className="mb-8">
              <h1 className="text-4xl font-black text-slate-900 mb-2 tracking-tight">New Account</h1>
